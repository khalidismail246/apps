...
class ContainerTotal extends StatefulWidget {
  const ContainerTotal({super.key, required this.total, required this.title});

  final String title;
  final Map<String, int> total;

  @override
  State<ContainerTotal> createState() => _ContainerTotalState();
}

class _ContainerTotalState extends State<ContainerTotal> {
  bool isHidden = false;
